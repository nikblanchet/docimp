...
export class ConfigErrorClassifier {
  ...
  private static createSyntaxSuggestions(errorMessage: string): string[] {
    ...
    suggestions.push('Validate JavaScript syntax in your editor');
  ...
  private static createRuntimeSuggestions(errorMessage: string): string[] {
    ...
    if (errorMessage.includes('Cannot find module')) {
      suggestions.push('Verify all import/require paths are correct');
      ...
      suggestions.push('Verify all import/require statements are valid');
      suggestions.push('Check file permissions allow reading');
    }
