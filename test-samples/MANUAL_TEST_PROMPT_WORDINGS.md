...
**Issue:** #234 **Related Bug:** #231 **Branch:** `issue-234-test-prompt-wordings`

## Objective

Test three prompt wording options to determine which most effectively prevents Claude
from wrapping docstring responses in markdown code fences.
...
**Strategy:** Direct prohibition of markdown wrappers **Risk:** Might be too specific,
...
**Strategy:** Explain the context and purpose **Risk:** Less explicit, relies on Claude
...
**Strategy:** Show expected output format with examples **Risk:** More verbose,
language-specific
...
Create separate files for each option: `RESULTS_OPTION_A.md`, `RESULTS_OPTION_B.md`,
`RESULTS_OPTION_C.md`
